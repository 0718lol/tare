...
class Rule:
    ...
    probe: Probe
    note: str = ""                 # 人读说明（中文）
    note_en: str = ""              # English note; falls back to note if empty
